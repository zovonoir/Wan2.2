...
RUN pip3 install --no-cache-dir peft=="0.17.1"
...
RUN git clone https://github.com/ROCm/aiter.git aiter && cd aiter && git checkout a6652a7790627ec769aa42f56da1d51001e63f98  && git submodule sync && git submodule update --init --recursive && python3 setup.py develop
