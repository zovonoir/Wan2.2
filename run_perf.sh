...
docker rmi wan2.2_rocm7.0.2_pytorch_2.10.0.dev20251023_iris_0dfc460_1

docker build -f dockerfile_rocm_7.0.2 -t wan2.2_rocm7.0.2_pytorch_2.10.0.dev20251023_iris_0dfc460_1 .
...
docker run  -d \
        ...
        -t wan2.2_rocm7.0.2_pytorch_2.10.0.dev20251023_iris_0dfc460_1
