...
iris_q = torch.randn([1,13640*8,5,128],dtype=torch.bfloat16,device="cuda")
iris_k = torch.randn([1,13640*8,5,128],dtype=torch.bfloat16,device="cuda")
iris_v = torch.randn([1,13640*8,5,128],dtype=torch.bfloat16,device="cuda")
...
fa_reference = flash_attention(
    iris_q,
    iris_k,
    iris_v,
    k_lens=torch.tensor([109120],dtype=torch.long,device="cuda"),
    window_size=(-1,-1),
)
torch.cuda.synchronize()

ai_output = flash_attention_aiter(
    iris_q,
    iris_k,
    iris_v,
    k_lens=torch.tensor([109120],dtype=torch.long,device="cuda"),
