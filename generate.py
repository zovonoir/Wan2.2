...
def generate(args):
    ...
    if world_size > 1:
        ...
        lock = shmem.zeros([4096], dtype=torch.int32,device="cuda")
        iris_all_to_all_buffers = [all_to_all_buffer_q,all_to_all_buffer_k,all_to_all_buffer_v,all_to_all_buffer_o,attn_buffer,lock]
