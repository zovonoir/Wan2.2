...
class WanI2V:
    ...
    def generate(self,
        ...
        msk = torch.ones(1, F, lat_h, lat_w, device=self.device) #fix frames being hardcoded to 81
        msk[:, 1:] = 0
        msk = torch.concat([
        ...
        with amp.autocast(dtype=self.param_dtype), torch.no_grad(), no_sync():
            ...
            trace_path = f"wan2.1_trace_rank{self.rank}.json"
            ...
            print(f"Elapsed time for dit : {elapsed_time_sec:.2f} seconds")
