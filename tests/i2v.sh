...
torchrun --nproc_per_node=8 $PY_FILE --task i2v-A14B --size 1280*720 --frame_num 121 --ckpt_dir $CKPT_DIR --prompt "$PROMPT" --image examples/i2v_input.JPG --ulysses_size 8 --base_seed 493227 --save_file $SAVEFILE_DIR/$SAVEFILE_NAME
